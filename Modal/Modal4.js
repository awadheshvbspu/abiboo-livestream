    ...
    <>
      ...
      >
        <Modal.Header closeButton >
          <Modal.Title className='fw-bold fs-5' style={{paddingLeft:"10.5rem"}}>Turn off video for  EveryOne?</Modal.Title>
        </Modal.Header>
        <Modal.Body className='text-center fw-bold'>
         This will switchOff video everyone in the meeting except you
    </Modal.Body>
